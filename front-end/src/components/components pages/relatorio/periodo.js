            ...
            <div className="pt-3">
                <div className="input-group mb-3 pt-3">
                    <div className="input-group-prepend">
                        ...
                        <input type="date" value={inputDataInicio} className="form-control" onChange={(evt) => setInputDataInicio(evt.target.value)}></input>
                    </div>
                </div>
                <div className="input-group mb-3 pt-3">
                    <div className="input-group-prepend">
                        <label className="input-group-text pr-4">Até:</label>
                        <input type="date" value={inputDataFim} className="form-control" onChange={(evt) => setInputDataFim(evt.target.value)}></input>
                    </div>
                </div>
                <Button variant="primary" onClick={() => mudarIntervaloDatas(inputDataInicio, inputDataFim)}>Gerar</Button>
            </div>
        </div>
    )
}
